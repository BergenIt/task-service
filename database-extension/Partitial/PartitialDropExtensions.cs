...
public static class PartitialDropExtensions
{
    ...
    {
        await db.DropPartialTable<TEntity>(dropRartitialCommands.AsEnumerable());
    }
    ...
    private static string HashHMACSHA1(string value)
    {
        ...
        return Convert.ToBase64String(new HMACSHA256(Encoding.UTF8.GetBytes("EMS")).ComputeHash(unicodeValue));
    }
